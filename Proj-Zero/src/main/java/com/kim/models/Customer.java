...
public class Customer extends User {
	...
	public Customer(int id, String name, String email, String password, int c_id, double creditLine, double amountDue) {
	...
	public Customer(String name, String email, String password, double creditLine, double amountDue) {
